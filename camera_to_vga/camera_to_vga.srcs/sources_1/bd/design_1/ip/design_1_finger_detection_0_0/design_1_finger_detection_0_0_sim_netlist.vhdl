...
-- Date        : Mon Mar  9 12:53:29 2020
-- Host        : DESKTOP-BBJD4E6 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/ECE532/ECE532_Group5/camera_to_vga/camera_to_vga.srcs/sources_1/bd/design_1/ip/design_1_finger_detection_0_0/design_1_finger_detection_0_0_sim_netlist.vhdl
...
entity design_1_finger_detection_0_0_finger_detection is
  ...
  attribute ORIG_REF_NAME of design_1_finger_detection_0_0_finger_detection : entity is "finger_detection";
end design_1_finger_detection_0_0_finger_detection;

architecture STRUCTURE of design_1_finger_detection_0_0_finger_detection is
...
detected_i_1: unisim.vcomponents.LUT6
    generic map(
...
detected_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
detected_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
detected_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
detected_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
entity design_1_finger_detection_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of design_1_finger_detection_0_0 : entity is "design_1_finger_detection_0_0,finger_detection,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_finger_detection_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_finger_detection_0_0 : entity is "finger_detection,Vivado 2018.1";
end design_1_finger_detection_0_0;

architecture STRUCTURE of design_1_finger_detection_0_0 is
