...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finger_detection is
  ...
  signal \detected[1]_i_12_n_0\ : STD_LOGIC;
...
\detected[1]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\detected[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFB0000"
        ...
        port map (
      I0 => \detected[1]_i_4_n_0\,
      I1 => \detected[1]_i_5_n_0\,
      I2 => \detected[1]_i_6_n_0\,
      I3 => \detected[1]_i_7_n_0\,
      I4 => nw2_reg(15),
      I5 => \detected[1]_i_8_n_0\,
      O => detected0
    );
\detected[1]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => \detected[1]_i_11_n_0\,
      I3 => \detected[1]_i_12_n_0\,
      O => \detected[1]_i_3_n_0\
    );
\detected[1]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\detected[1]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\detected[1]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\detected[1]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\detected[1]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\detected[1]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
