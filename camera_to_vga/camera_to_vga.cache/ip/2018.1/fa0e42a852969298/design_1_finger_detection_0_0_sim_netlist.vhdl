...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finger_detection is
  ...
  signal \detected[1]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \detected[2]_i_4_n_0\ : STD_LOGIC;
  ...
  signal nw1 : STD_LOGIC;
  signal \nw1[0]_i_3_n_0\ : STD_LOGIC;
  signal \nw1[0]_i_4_n_0\ : STD_LOGIC;
  ...
  signal nw4 : STD_LOGIC;
  signal \nw4[0]_i_3_n_0\ : STD_LOGIC;
  signal \nw4[0]_i_4_n_0\ : STD_LOGIC;
  signal \nw4[0]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \x_coord[6]_i_2_n_0\ : STD_LOGIC;
  signal \x_coord[7]_i_1_n_0\ : STD_LOGIC;
  signal \x_coord[7]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \nw1[0]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \nw4[0]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \nw4[0]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \x_coord[0]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \x_coord[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \x_coord[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \x_coord[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \x_coord[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \x_coord[6]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \x_coord[7]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \x_coord[7]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \x_coord[8]_i_6\ : label is "soft_lutpair5";
begin
...
\detected[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF8"
    )
        port map (
...
\detected[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\detected[1]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\detected[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\detected[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFF0F0FFFEF0F0"
    )
        port map (
...
\detected[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF0000FFFE0000"
    )
        port map (
...
\detected[3]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\detected[3]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\detected[3]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\detected[3]_i_8\: unisim.vcomponents.LUT6
    generic map(
...
\detected[3]_i_9\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FD"
    )
        port map (
...
\nw1[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"000010F0"
    )
        port map (
...
\nw1[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\nw1[0]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\nw2[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"000AA080"
    )
        port map (
...
\nw2[0]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\nw4[0]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\nw4[0]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\nw4[0]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\x_coord[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F00FF0F0F00FB0B0"
    )
        port map (
      I0 => x_coord(4),
      I1 => x_coord(8),
...
\x_coord[6]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\x_coord[7]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\x_coord[8]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\x_coord[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\x_coord[8]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\x_coord[8]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
