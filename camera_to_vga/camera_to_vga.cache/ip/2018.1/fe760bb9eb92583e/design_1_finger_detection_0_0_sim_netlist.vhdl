...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finger_detection is
  ...
  signal \x_coord_reg_n_0_[0]\ : STD_LOGIC;
  signal \x_coord_reg_n_0_[1]\ : STD_LOGIC;
  signal \x_coord_reg_n_0_[2]\ : STD_LOGIC;
  signal \x_coord_reg_n_0_[3]\ : STD_LOGIC;
  signal \x_coord_reg_n_0_[4]\ : STD_LOGIC;
  signal \x_coord_reg_n_0_[5]\ : STD_LOGIC;
  signal \x_coord_reg_n_0_[6]\ : STD_LOGIC;
  signal \x_coord_reg_n_0_[7]\ : STD_LOGIC;
  signal \x_coord_reg_n_0_[8]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \detected[0]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \detected[1]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \x_coord[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \x_coord[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \x_coord[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \x_coord[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \x_coord[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \x_coord[6]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \x_coord[7]_i_1\ : label is "soft_lutpair2";
...
\detected[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\detected[1]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\detected[1]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFFFF"
    )
        port map (
...
\detected[1]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\detected[1]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\detected[1]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\detected[1]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\x_coord[8]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\x_coord[8]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\x_coord[8]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
