...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finger_detection is
  ...
  attribute SOFT_HLUTNM of \detected[0]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \detected[0]_i_4\ : label is "soft_lutpair0";
begin
  detect(0) <= \^detect\(0);
...
\detected[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
