// -------------------------------------------------------------
// 
// File Name: /home/shahryar/Desktop/ECE532/TestHDLMatlab/hdlsrc/test2/DeltaSigma.v
...
// 
// Module: DeltaSigma
// Source Path: test2/HDL_DUT/DeltaSigma
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module DeltaSigma
  ...
  output  signed [23:0] out7;  // sfix24_En14
  ...
  wire signed [16:0] Sum2_sub_cast;  // sfix17_En14
  wire signed [16:0] Sum2_sub_cast_1;  // sfix17_En14
  wire signed [16:0] Sum2_out1;  // sfix17_En14
  wire signed [33:0] Gain1_out1;  // sfix34_En28
  ...
  assign Constant_out1 = 16'sb0010000000000000;


  assign Data_Type_Conversion6_out1 = {1'b0, {Compare_To_Zero_out1, 14'b00000000000000}};


  assign Sum2_sub_cast = {Data_Type_Conversion6_out1[15], Data_Type_Conversion6_out1};
  assign Sum2_sub_cast_1 = {Constant_out1[15], Constant_out1};
  assign Sum2_out1 = Sum2_sub_cast - Sum2_sub_cast_1;


  assign Gain1_out1 = {{2{Sum2_out1[16]}}, {Sum2_out1, 15'b000000000000000}};


  assign Data_Type_Conversion7_out1 = {{4{Gain1_out1[33]}}, Gain1_out1[33:14]};
  ...
  assign Integrator = Discrete_Time_Integrator_x_reg;

  assign out7 = Mixed_Signal;
