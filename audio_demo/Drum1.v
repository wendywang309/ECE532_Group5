// -------------------------------------------------------------
// 
// File Name: /home/shahryar/Desktop/ECE532/TestHDLMatlab/hdlsrc/audio_setup/Drum1.v
...
// 
// Module: Drum1
// Source Path: audio_setup/audio_core/Drum1
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Drum1
  ...
  alpha123Hz_Sin u_123Hz_Sin (.clk(clk),
                              .reset(reset),
                              .enb(enb),
                              .In1(enb_1),
                              .Out1(alpha123Hz_Sin_out1)  // sfix20_En18
                              );
  fader_1_1_28ms u_fader_1_1_28ms (.clk(clk),
                                   .reset(reset),
                                   .enb(enb),
                                   .Input_rsvd(alpha123Hz_Sin_out1),  // sfix20_En18
                                   .reset_1(rst),
                                   .enb_1(enb_1),
                                   .Out1(fader_1_1_28ms_out1)  // sfix20_En18
                                   );
  alpha190Hz_Trig_block u_190Hz_Trig (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .In1(enb_1),
                                      .Out1(alpha190Hz_Trig_out1)  // sfix20_En16
                                      );
  fader_2_0_32ms u_fader_2_0_32ms (.clk(clk),
                                   .reset(reset),
                                   .enb(enb),
                                   .Input_rsvd(alpha190Hz_Trig_out1),  // sfix20_En16
                                   .reset_1(rst),
                                   .enb_1(enb_1),
                                   .Out1(fader_2_0_32ms_out1)  // sfix20_En18
                                   );
  always @(posedge clk or posedge reset)
  ...
  assign fader_2_0_32ms_out1_1 = delayMatch_reg[5];
  assign delayMatch_reg_next[0] = fader_2_0_32ms_out1;
  ...
  alpha285Hz_Trig1_block u_285Hz_Trig1 (.clk(clk),
                                        .reset(reset),
                                        .enb(enb),
                                        .In1(enb_1),
                                        .Out1(alpha285Hz_Trig1_out1)  // sfix20_En16
                                        );
  fader_3_0_64ms u_fader_3_0_64ms (.clk(clk),
                                   .reset(reset),
                                   .enb(enb),
                                   .Input_rsvd(alpha285Hz_Trig1_out1),  // sfix20_En16
                                   .reset_1(rst),
                                   .enb_1(enb_1),
                                   .Out1(fader_3_0_64ms_out1)  // sfix20_En18
                                   );
  always @(posedge clk or posedge reset)
  ...
  assign fader_3_0_64ms_out1_1 = delayMatch1_reg[5];
  assign delayMatch1_reg_next[0] = fader_3_0_64ms_out1;
  ...
  assign Sum1_add_cast = {{2{fader_1_1_28ms_out1[19]}}, fader_1_1_28ms_out1};
  assign Sum1_add_cast_1 = {{2{fader_2_0_32ms_out1_1[19]}}, fader_2_0_32ms_out1_1};
  assign Sum1_add_temp = Sum1_add_cast + Sum1_add_cast_1;
  assign Sum1_add_cast_2 = {{2{fader_3_0_64ms_out1_1[19]}}, fader_3_0_64ms_out1_1};
