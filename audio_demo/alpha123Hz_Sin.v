// -------------------------------------------------------------
// 
// File Name: /home/shahryar/Desktop/ECE532/TestHDLMatlab/hdlsrc/audio_setup/alpha123Hz_Sin.v
...
// -------------------------------------------------------------
// 
// Module: alpha123Hz_Sin
// Source Path: audio_setup/audio_core/Drum1/123Hz Sin
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module alpha123Hz_Sin
  ...
  reg [20:0] HDL_Counter5_stepreg;  // ufix21
  ...
  always @(posedge clk or posedge reset)
    begin : HDL_Counter5_step_process
      if (reset == 1'b1) begin
        HDL_Counter5_stepreg <= 21'b000000000000000000001;
      end
      else begin
        if (enb) begin
          if (In1 == 1'b1) begin
            if (HDL_Counter5_out1 == 21'b001100100100001111100) begin
              HDL_Counter5_stepreg <= 21'b100110110111100000100;
            end
            else begin
              HDL_Counter5_stepreg <= 21'b000000000000000000001;
            end
  ...
  always @(posedge clk or posedge reset)
    begin : HDL_Counter5_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (In1 == 1'b1) begin
            HDL_Counter5_out1 <= HDL_Counter5_out1 + HDL_Counter5_stepreg;
          end
        end
      end
    end
