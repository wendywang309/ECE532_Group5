...
module audio_core
  ...
  wire enb;
  wire signed [32:0] kconst;  // sfix33_En33
  reg signed [32:0] kconst_1;  // sfix33_En33
  ...
  wire signed [67:0] Gain1_out1;  // sfix68_En63
  ...
  reg signed [32:0] Sum1_out1_1;  // sfix33_En30
  wire signed [65:0] Gain_out1;  // sfix66_En63
  reg signed [65:0] HwModeRegister_reg [0:1];  // sfix66 [2]
  wire signed [65:0] HwModeRegister_reg_next [0:1];  // sfix66_En63 [2]
  wire signed [65:0] Gain_out1_1;  // sfix66_En63
  ...
  wire signed [74:0] Product_mul_temp;  // sfix75_En71
  wire signed [73:0] Product_out1;  // sfix74_En71
  reg signed [73:0] Product_out1_1;  // sfix74_En71
  wire signed [23:0] Data_Type_Conversion1_out1;  // sfix24_En14
  wire DeltaSigma_out1;


  assign kconst = 33'sh0A8F5C28F;
  ...
  assign Data_Type_Conversion7_out1 = Gain1_out1[64:33];
  ...
  assign Gain_out1 = kconst_1 * Sum1_out1_1;


  always @(posedge clk or posedge reset)
    begin : HwModeRegister_process
      if (reset == 1'b1) begin
        HwModeRegister_reg[0] <= 66'sh00000000000000000;
        HwModeRegister_reg[1] <= 66'sh00000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Data_Type_Conversion1_out1 = {{7{Product_out1_1[73]}}, Product_out1_1[73:57]};
