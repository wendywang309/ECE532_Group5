...
HD_PWD='C:/ECE532/ECE532_Group5/virtual_instruments/virtual_instruments.runs/design_1_audio_core_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_audio_core_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_audio_core_0_0.tcl
