...
HD_PWD='C:/ECE532/ECE532_Group5/bluetooth_nddr/bluetooth.runs/design_1_design_1_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_design_1_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_design_1_wrapper_0_0.tcl
